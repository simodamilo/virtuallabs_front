...
@Component({
  ...
  template: `<mat-form-field>
              ...
              <mat-autocomplete #auto [displayWith]="displayFn" (optionSelected)="selectedOption($event)">
                <mat-option *ngFor="let option of _filteredOptions" [value]="option">
...
export class AutocompleteComponent {
  ...
  _allOptions: Student[] | Teacher[];
  _filteredOptions: Student[] | Teacher[];
  _type: string;
  ...
  customFilter(value: string = '') {
    this._filteredOptions = this._allOptions.filter((s) =>
      value === ''
        ? true
  ...
  /**
   * Used to update the selected option of the automplete.
   * 
   * @param event generated by the autocomplete field.
   */
